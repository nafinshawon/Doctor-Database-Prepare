              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    $id=1;
                    $query ="SELECT count(distinct mReporting_DRID) as TOTAL_DOCTOR_COUNT FROM skf_drlist WHERE FMTR ='$TRCODE' AND ACTIVE_STATUS= '1' ; ";
    ...
    <div class="col-12">
        ...
        <tbody>
                ...
                <?php
                    ...
                    $id=1;
                    $query ="SELECT * FROM skf_drlist WHERE FMTR ='$TRCODE' AND ACTIVE_STATUS= '1' ORDER BY SL DESC; ";
