              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    // TOTAL DOCTOR COUNT 
                    $id=1;
                    $query ="SELECT count(distinct mReporting_DRID) as TOTAL_DOCTOR_COUNT FROM skf_drlist WHERE TRCODE ='$TRCODE' AND EMPID = '$EMPID' ; ";
                    ...
                    <?php } //END OF TOTAL DOCTOR COUNT
                     ?>
                    <!--   -->
                    <?php
                        // TOTAL ACTIVE DOCTOR COUNT 
                        $id1=1;
                        $query ="SELECT count(distinct mReporting_DRID) as TOTAL_ACTIVE_DOCTOR_COUNT FROM skf_drlist WHERE TRCODE ='$TRCODE' AND EMPID = '$EMPID' AND ACTIVE_STATUS='1' ; ";
                   

                        $result = $conn->query($query) or die( " TOTAL_ACTIVE_DOCTOR_COUNT query failed");
                    
                        if($result->num_rows>0){ 
                            while($row = $result->fetch_assoc()){ 
                                $TOTAL_ACTIVE_DOCTOR_COUNT = $row['TOTAL_ACTIVE_DOCTOR_COUNT'];
                    ...
                    ?>
                        ...
                        <div>
                           <!-- <button type="submit" class="btn btn-secondary">Cancel</button>  -->
                            <a href="doctor_index.php"><button type="submit" name = "back" class="btn btn-primary" >Home</button></a>
                            <a href="doctor_index.php"><button name='submitNewDoctor' id='submitNewDoctor' class="btn btn-primary">Add New</button></a> 
                            <button name='' id='' class="btn" readonly>Total Doctor Count : <?php echo $TOTAL_DOCTOR_COUNT; ?></button>
                            <button name='' id='' class="btn" readonly>Active Doctor Count : <?php echo $TOTAL_ACTIVE_DOCTOR_COUNT; ?></button>
                        </div>
    ...
    <div class="col-12">
        ...
        <thead>
          <tr>
            ...
            <th scope="col" style="font-size:11px;">mReporting_DRDDRESS</th>
            <th scope="col" style="font-size:11px;">NOP</th>
            <th scope="col" style="font-size:11px;">NOP Category</th>
            <th scope="col" style="font-size:11px;">Doctor Category</th>
            <th scope="col" style="font-size:11px;">Speciality</th>
            <th scope="col" style="font-size:11px;">Degree</th>
            <th scope="col" style="font-size:11px;">DOCTOR TYPE</th>
        ...
        <tbody>
                ...
                <?php
                    ...
                    $id=1;
                    $query ="SELECT * FROM skf_drlist WHERE TRCODE ='$TRCODE' AND EMPID = '$EMPID' ORDER BY SL DESC; ";
                    ...
                    <tr>
                        ...
                        <td style="font-size:10px;"><?php echo $row['mReporting_Address'] ?></td>
                        <td style="font-size:10px;"><?php echo $row['mReporting_NOP'] ?></td>
                        <td style="font-size:10px;"><?php echo $row['Category'] ?></td>
                        <td style="font-size:10px;"><?php echo $row['DSR_Doctor_Category'] ?></td>
                        <td style="font-size:10px;"><?php echo $row['mReporting_SPECIALITY'] ?></td>
                        <td style="font-size:10px;"><?php echo $row['mReporting_DEGREE'] ?></td>
                        <td style="font-size:10px;"><?php echo $row['Doctor_Type'] ?></td>
                        <td style="font-size:10px;"><?php echo $row['mReporting_Mobile'] ?></td>
