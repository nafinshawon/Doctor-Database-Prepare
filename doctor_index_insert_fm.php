...
if (isset($_POST['submitDoctor'])) {
  // receive all input values from the form
    ...
    $query1 = "SELECT FMTR, RSMTR, NSMID, NSMNAME FROM skf_rfieldforce WHERE FMTR='".$FMTR."'";
 ...
 /*   $mReportingDRInfo      = isset($_POST["mReporting_DRID"]) ? $_POST["mReporting_DRID"] : '';
    ...
    if($allcount == 0){
        ...
        echo "<script type='text/javascript'>
                    window.location='doctor_index_fm.php';
                </script>";
    }
...
?>
    ...
    <script type="text/javascript">
      ...
      // window.location.replace('http://skfmis.com/doctorlist/doctor_List_View_fm.php');
