              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    $id=1;
                    $query ="SELECT count(distinct mReporting_DRID) as TOTAL_DOCTOR_COUNT FROM skf_drlist WHERE FMTR ='$TRCODE'  ; ";
                    ...
                    <?php } ?>
                        ...
                        <div>
                           <!-- <button type="submit" class="btn btn-secondary">Cancel</button>  -->
                            ...
                            <a href="doctor_List_View_fm_mso_all.php"><button name='ViewAllFMDoctor' id='ViewAllFMDoctor' class="btn btn-primary">All MSOTR</button></a>
      ...
      <!--   <div class="col-sm-3" style="float: right;">
        ...
        <tbody>
          ...
          <!--  <tbody id="myTable"> -->
            ...
            <?php
                include("connection.php");
                $query ="SELECT * FROM skf_drlist WHERE FMTR ='$TRCODE' ORDER BY TRCODE ; ";
                ...
                while($row = $result->fetch_assoc())
                {
                    $id = $row['mReporting_DRID'];   
                    //echo $id;
                    //echo "<tr align='center'>"; 
                    echo"<td>" .$x."</font></td>";
                    echo"<td>" .$row['TRCODE']."</font></td>";
                    echo"<td>" .$row['mReporting_DRID']."</font></td>"; 
                    echo"<td>" .$row['mReporting_DRNAME']."</font></td>";
                    echo"<td>". $row['mReporting_Address']. "</font></td>";
                    echo"<td>". $row['mReporting_Mobile']. "</font></td>";
                    echo"<td>". $row['BRAND1']. "</font></td>";
                    echo"<td>". $row['BRAND2']. "</font></td>";   
                    echo"<td>" .$row['BRAND3']."</font></td>";
                    echo"<td>". $row['BRAND4']. "</font></td>";
                    echo"<td>". $row['BRAND5']. "</font></td>";
                    echo"<td>". $row['DSR_DRID']. "</font></td>";   
                    echo"<td>" .$row['DSR_DRNAME']."</font></td>";
                    echo"<td>". $row['DSR_Address']. "</font></td>";
                    echo"<td>". $row['DRID_4P']. "</font></td>";
                    echo"<td>". $row['DRNAME_4P']. "</font></td>";   
                    echo"<td>" .$row['Address_4P']."</font></td>";
                    echo"<td>" .$row['TO_DATE']."</font></td>";
                    echo"<td>" .$row['ACTIVE_STATUS']."</font></td>";
                    echo"<td><a href ='doctor_index_fm_edit.php?mReporting_DRID=$id' target='_blank'><button name='EditDoctor' id='EditDoctor' class='btn btn-primary'>Edit</button></a>";
                    //echo"<td><a href ='doctorlist_edit_view.php?mReporting_DRID=$id' target='_blank'><button name='EditDoctor' id='EditDoctor' class='btn btn-primary'>Edit</button></a>";
